...
$("#wool").mouseover(function () {
    $("#link-text").html("查收省钱攻略");
}).mouseout(function () {
...
$("#unity").mouseover(function () {
    $("#link-text").html("贵司缺Unity3D开发吗");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#afdian").mouseover(function () {
    $("#link-text").html("为小站发电");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
